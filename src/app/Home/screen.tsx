      ...
      <section className="text-gray-600 body-font bg-gray-50">
        <div className="container px-5 py-24 mx-auto flex flex-wrap flex-col">
          ...
          <div className="flex flex-col text-center w-full">
            <h1 className="lg:text-4xl text-2xl font-bold  title-font mb-4 text-gray-900">
              Bloging WebSite & Application
            </h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            Welcom to the bloging website Create a professional blogs and push their 
            <br />Read and write bloging website
            </p>
          </div>
        </div>
      </section>
